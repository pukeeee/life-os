...
import type { CategoryRow } from "@backend/infrastructure/persistence/drizzle/schema";
import { categories } from "@backend/infrastructure/persistence/drizzle/schema";
